...
if __name__ == '__main__':
    ...
    select_columns = "select code,name,industry,pe,pe_ttm,wave_a,wave_b,w_gap,c_gap,bottom,uspace,dspace,count,count_,fdate,last_f_date,price,call_price,call_diff,select_time "
