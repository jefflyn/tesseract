...
if __name__ == '__main__':
    ...
    select_columns = "select code,name,industry,pe,pe_ttm,a_days,wave_a,wave_b,b_days,w_gap,c_gap,bottom,uspace,dspace,count,count_,fdate,last_f_date,price,call_price,call_diff,concepts,select_time "
