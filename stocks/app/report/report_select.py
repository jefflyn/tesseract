...
if __name__ == '__main__':
    ...
    select_columns = "select code,name,industry,pe,pe_ttm,pct_change,list_date,a_days,wave_a,wave_b,b_days,w_gap,c_gap,count,count_,fdate,last_f_date,price,call_price,call_diff,concepts,select_time "
    sql_all = select_columns + "from select_result_all order by wave_a"
    df_all = _dt.read_query(sql_all)

    date_util.get_trade_day()
