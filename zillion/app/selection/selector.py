...
# from zillion.data.service import hist_trade_service
...
def select_result(codeset=None, filename=''):
    ...
    print('select zillion start! total size: %d\n' % size)
    data_list = []
    # 概念信息
    ...
    print('select zillion finished, consume time %d secs! result size: %d\n' %
