...
holding_cost = {
    'TA2401': [5872, 6], 'PP2401': [-7164, 0], 'EB2401': [8000, 0], 'PG2401': [5000, 0],
    'FG2401': [1546, 0], 'SA2401': [2015, 3], 'SF2402': [6986, 3], 'I2401': [-931, 1],
    'UR2401': [-2373, 2], 'JM2401': [1300, 0], 'J2401': [2000, 0], 'SI2308': [12550, 0],
    'OI2401': [-8830, 1], 'P2401': [1974, 0], 'PK2401': [9014, 3], 'RM2401': [2898, 5],
    'AL2308': [15000, 0], 'AG2312': [1234, 0], 'SN2312': [200000, 0], 'NI2312': [184000, 0],
    'SP2401': [-6156, 2], 'CJ2401': [-15230, 1], 'NR2401': [9000, 0], 'CF2401': [-16760, 0]
}
