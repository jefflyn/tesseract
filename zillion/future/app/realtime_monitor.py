...
init_target = {
    ...
    # 'NI2403': [[-123000], [124250, 127500]],
    # 'AL2312': [[-17345.0], [20000]],
    # 'SI2401': [[-12000], [15000]],

    'RM2405': [[-2400], [2500, 2540]],
    'OI2405': [[-7350], [7920]],
    # 'P2405': [[-7000], [8000]],
    'CJ2405': [[-12000], [13000]],
    # 'CF2405': [[-14500], [16200]],
...
holding_cost = {
    ...
    'CJ2405': [12715, 0], 'CF2405': [-16760, 0], 'NR2404': [9000, 0],

    'TA2405': [5752, 0], 'PP2405': [-7164, 0], 'EB2403': [8000, 0], 'PG2403': [4350, 4],
    'FG2405': [1814, 5], 'SA2405': [2015, 0], 'UR2405': [2148, 5], 'SP2405': [5672, 4],

    'SF2405': [6500, 10], 'I2405': [-979, 0], 'JM2405': [1300, 0], 'J2405': [2000, 0],
    'AL2308': [15000, 0], 'SI2308': [12550, 0], 'AG2406': [5915, 0], 'SN2403': [200000, 0], 'NI2403': [124000, 0]
}
