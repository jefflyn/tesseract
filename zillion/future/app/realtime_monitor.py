...
holding_cost = {
    ...
    'FG2405': [-1814, 5], 'SA2405': [2015, 0], 'SF2405': [6588, 0], 'I2405': [-979, 0],
    'UR2405': [2061, 0], 'JM2405': [1300, 0], 'J2405': [2000, 0], 'SI2308': [12550, 0],
    'OI2405': [7978, 0], 'P2405': [1974, 0], 'PK2403': [8878, 8], 'RM2405': [2520, 0],
    'AL2308': [15000, 0], 'AG2406': [-5800, 0], 'SN2403': [200000, 0], 'NI2403': [184000, 0],
